...
import { ChevronLeft, Link, Loader, Mic } from 'lucide-react';
...
const ChatsDetails = () => {
    ...
    const renderContent = () => {
        ...
        return (
            <div className="flex flex-col h-full w-full bg-gray-100 text-black">
                <div className="flex items-center justify-between px-4 py-4 border-b">
                    <button onClick={() => router.back()} className="mr-2">
                        <ChevronLeft className="cursor-pointer" size={26} />
                    </button>
