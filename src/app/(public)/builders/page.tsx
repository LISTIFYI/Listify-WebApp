    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <div className={`grid grid-cols-1  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-y-5 gap-x-4 ${!loading && !!allBuilders?.length ? "lg:p-6 p-4" : "lg:p-0 p-0"}`} >
