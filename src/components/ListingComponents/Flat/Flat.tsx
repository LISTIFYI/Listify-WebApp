...
const Flat = ({
    ...
    const handleSelectionChangeChip = (selectedChips: string[]) => {
        setAmenitiesdata(selectedChips);
    };

    const handleSelectionChangeChip2 = (selectedChips: string[]) => {
        setHighlights(selectedChips);
    };
